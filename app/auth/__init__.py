...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('auth.dashboard'))
    return render_template('profile_edit.html', form=form, dateThing=(current_user.registered_on.strftime('%m/%d/%y')))
...
def edit_account():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('auth.dashboard'))
    return render_template('manage_account.html', form=form, dateThing=(current_user.registered_on.strftime('%m/%d/%y')))